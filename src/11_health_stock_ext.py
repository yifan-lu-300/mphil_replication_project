...
# Read data
sample = pd.read_csv(os.path.join(derived_path, 'sample_simulate_retire_ext.csv'))
...
########## Save data
sample.to_csv(os.path.join(derived_path, 'sample_health_stock_ext.csv'), index=False)
